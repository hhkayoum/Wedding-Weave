...
const Footer = () => {
  return (
    <footer className="divide-y bg-[#ebeeeb] text-black">
      <div className="max-w-screen-2xl px-4 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3 my-8 lg:my-0">
          ...
          >
            <div className="flex items-center justify-center w-9 h-9 rounded-full bg-[##836B6C]">
              <img
                src="https://i.ibb.co/YpTkJyx/Screenshot-2023-11-24-114929-removebg-preview.png"
                alt=""
              />
            </div>
            <span className="self-center text-2xl font-semibold text-[#836B6C]">
              Wedding Weave
            </span>
          </Link>
        </div>
      ...
      <div className="py-6 text-sm text-center border-t border-gray-400 text-gray-600">
        © 2023 WeddingWeave. All rights reserved.
      </div>
    </footer>
  );
};
