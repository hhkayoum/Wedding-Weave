...
const EditBiodata = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const biodataItem = await axiosPublic.post("/biodata", biodataDetails);

    if (biodataItem.data.insertedId) {
      // show success popup
      Swal.fire({
        position: "top-end",
        icon: "success",
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="mb-4">
                ...
                />
                {errors.fathersName && (
                  <span className="text-red-600">Fathers Name is required</span>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                />
                {errors.mothersName && (
                  <span className="text-red-600">Mothers Name is required</span>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  className="w-full p-2 border rounded-md focus:outline-none focus:ring focus:border-[#836B6C]"
                >
                  <option value="">Select a Permanent Division</option>
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  className="w-full p-2 border rounded-md focus:outline-none focus:ring focus:border-[#836B6C]"
                >
                  <option value="">Select a Present Division</option>
                  <option value="Dhaka">Dhaka</option>
                  <option value="Chattogram">Chattogram</option>
                  <option value="Rajshahi">Rajshahi</option>
                  <option value="Khulna">Khulna</option>
            ...
            <div className="mt-4">
              {profileData.length > 0 ? (
                ...
                <Link to={`/dashboard/updateBiodata/`}>
                  <button className="bg-[#836B6C] text-white p-2 rounded w-full hover:bg-[#BFB2B3] focus:outline-none focus:ring focus:border-[#836B6C]">
                    Update Biodata
                  </button>
                </Link>
              ) : (
